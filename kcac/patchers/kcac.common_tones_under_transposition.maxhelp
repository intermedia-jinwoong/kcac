...
,
		"classnamespace" : "box",
		"rect" : [ 3558.0, 146.0, 1337.0, 719.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 99.0, 62.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 99.0, 81.0, 22.0 ],
					"text" : "0 2 4 5 7 9 11"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 97.5, 216.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"versionnumber" : 80100,
					"whole_tree_data_0000000000" : [ 1, 3, 5, 9, 11 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 251.0, 159.0, 22.0 ],
					"text" : "kcac.transpose_pitchclass 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.000000381000518, 145.5, 231.0, 22.0 ],
					"text" : "kcac.common_tones_under_transposition"
				}
...
, 			{
				"box" : 				{
					...
					"versionnumber" : 80100,
					"whole_tree_data_0000000000" : [ 0, 4, 0, 4, 0, 4 ],
					"whole_tree_data_count" : [ 1 ]
				}
